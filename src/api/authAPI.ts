import { apiBase, ResponseType, ResultCodeForCaptchaEnum, ResultCodesEnum } from "./API";
...
export const authAPI = {
    ...
    logout() {
        return apiBase.delete('/auth/login').then(res => res.data);
    },
}
...
type LoginResponseType = ResponseType<{userId: number}, ResultCodesEnum | ResultCodeForCaptchaEnum>
